...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "NHUTHIHI.COM"
	end
...
local scriptVersion = "0.2.0 BETA"
...
local function Webhook()
	pcall(function()
		...
		local data = {
			...
			["avatar_url"] = "https://tr.rbxcdn.com/5c9e29b3953ec061286e76f08f1718b3/512/512/Image/Png",
			["embeds"] = {
				{
					["author"] = {
...
local function ShopSniperWebhook(test)
	...
	pcall(function()
		...
		local data = {
			["content"] = "",
			["username"] = "Nhuthihi Thông Báo",
			["avatar_url"] = "https://tr.rbxcdn.com/c177d67285ad8c20f2a2e6738f12f381/150/150/AvatarHeadshot/Png",
			["embeds"] = {
				{
					["author"] = {
						["name"] = "Bulma's Shop",
...
function MainModule()
    ...
    mainWindow = RayfieldLibrary:CreateWindow({
        ...
        LoadingSubtitle = "Code test by HUY"
    })

    local autoFarmTab = mainWindow:CreateTab("Farm")
	local autoMacroTab = mainWindow:CreateTab("Macro [BETA]")
        ...
        autoFarmTab:CreateToggle({
            ...
            Callback =  function(bool)
                ...
                if exec == "Synapse X" and getgenv().AutoLoadTP then
                    syn.queue_on_teleport("loadstring(game:HttpGet('----scrip---'))()")
                ...
                elseif exec ~= "Synapse X" and getgenv().AutoLoadTP then
                    queue_on_teleport("loadstring(game:HttpGet('----scrip---'))()")
                end
...
--#endregion
    ...
    creditsTab:CreateLabel("HUY--(IT)")
    creditsTab:CreateLabel("NHUTHIHI321")
    creditsTab:CreateLabel("SHOP ROBUX NHUTHIHI.COM")
end
...
if game.PlaceId == 8304191830 then
    ...
    pcall(function() SpecialSummonSniperWebhook(false) end)
    pcall(function() StandardSummonSniperWebhook(false) end)
